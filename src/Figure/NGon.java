...
public class NGon implements IMoveable, IShape, IPolyPoint {
    protected int n;
    protected Point2D[] p;
    ...
    public Segment getSegment(int i) throws Exception {
        return new Segment(this.getP(i % this.getN()), this.getP((i + 1) % this.getN()));
    }
    ...
    public String toString() {
        ...
        res.append(this.p[this.getN() - 1].toString()).append("}");
        return res.toString();
    }
}
